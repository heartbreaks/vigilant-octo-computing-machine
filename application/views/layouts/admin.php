...
<?php if ($this->route['action'] != 'login'): ?>
    <header class="w-full text-gray-700 bg-white border-t border-gray-100 body-font">
        <div class="container flex flex-col items-start justify-between p-6 mx-auto md:flex-row">
            ...
            <nav class="flex flex-wrap items-center justify-center pl-6 ml-6 text-base border-l border-gray-200 md:mr-auto">
                <a href="/admin/posts" class="mr-5 font-medium hover:text-gray-900">Пользователи</a>
            </nav>
            <div class="items-center h-full">
                <a href="/admin/logout" class="mr-5 font-medium hover:text-gray-900">Выход</a>
            </div>
        </div>
    </header>
<?php endif; ?>
